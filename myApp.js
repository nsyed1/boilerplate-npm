...
var createAndSavePerson = function(done) {
  var noorSyed = new Person({name: 'Noor Syed', age: 31, favoriteFoods: ['biryani', 'tikka']});

  noorSyed.save(function(err, data){
...
var arrayOfPeople = [
  {name: 'Noor', age: 31, favoriteFoods: ['biryani', 'tikka']},
  {name: 'Bilal', age: 17, favoriteFoods: ['burger']},
...
var removeById = function(personId, done) {
  Person.findOneAndDelete({_id: personId}, function(err, person){
    if (err) return console.log(err);
    done(null, person);
  }) 
};
